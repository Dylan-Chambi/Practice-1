...
public class Client {
    public static void main(String[] args) {
        Estudiante estudiante1 = new Estudiante("John", "65656565");
        Estudiante estudiante2 = new Estudiante("Mary", "12345645");
        Estudiante estudiante3 = new Estudiante("Peter", "4561231");
        Estudiante estudiante4 = new Estudiante("Paul", "453186456");
        Estudiante estudiante5 = new Estudiante("Juan", "12374646");
